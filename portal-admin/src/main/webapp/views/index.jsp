...
<div class="header">
	<div class="logo lf"><a href="#" target="_blank"><span class="invisible">123幼儿园后台管理系统</span></a></div>
    <div class="rt-col">
    </div>
    <div class="col-auto">
    	<div class="log white cut_line">
			您好！${user.username}  [<c:choose><c:when test="${user.roleid == 0}">超级管理员</c:when><c:when test="${user.roleid == 1}">网站运营人员</c:when></c:choose>]<span>|</span>
			<a href="/logout">[退出]</a><span>|</span>
    		<a href="${siteUrl}" target="_blank" id="site_homepage">站点首页</a>
        ...
        <ul class="nav white" id="top_menu">
            ...
            <c:if test="${user.roleid == 0 || user.roleid==1}">
			<li id="_M4" class="top_menu" data="access-m"><a href="javascript:void(0);"  hidefocus="true" style="outline:none;">权限管理</a></li>
            </c:if>
			<li id="_M5" class="top_menu" data="teacher-mgr"><a href="javascript:void(0);"  hidefocus="true" style="outline:none;">用户管理</a></li>
<!-- 			<li id="_M6" class="top_menu" data="student-mgr"><a href="javascript:void(0);"  hidefocus="true" style="outline:none;">学生管理</a></li> -->
			<li id="_M2" class="top_menu" data="model-m"><a href="javascript:void(0);"  hidefocus="true" style="outline:none;">模块管理</a></li>
			<li id="_M3" class="top_menu" data="content-m"><a href="javascript:void(0);"  hidefocus="true" style="outline:none;">课程管理</a></li>
			<!-- li id="_M5" class="top_menu" data="setting"><a href="javascript:void(0);"  hidefocus="true" style="outline:none;">网站设置</a></li -->
    ...
    当前位置：<span id="current_pos">位置1 > 位置2 > 位置3 ></span></div>
    	<div class="col-1">
        	<div class="content" style="position:relative; overflow:hidden">
                <iframe name="right" id="rightMain" src="/empty" frameborder="false" scrolling="auto" style="border:none; margin-bottom:30px" width="100%" height="auto" allowtransparency="true"></iframe>
                <!-- div class="fav-nav">
					<div id="panellist">
											</div>
					<div id="paneladd"></div>
...
<script src="${adminUrl}/js/youda.home.js"></script>
