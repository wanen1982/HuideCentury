...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:;" class="on"> <em>添加轮播项</em>
		</a>
	</div>
		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="addCarousel" class="form-horizontal" action="/model/carousel/add" method="post" enctype="multipart/form-data">
						...
						<div class="control-group">
						    ...
						    <div class="controls">
						    	<textarea class="span5" name="desc" rows="4" maxlength="90"></textarea>
						    </div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
						    ...
						    <div class="controls">
						      <input type="text" name="linkUrl" maxlength="255"/>
						    </div>
						</div>
					</form>
				</div>
