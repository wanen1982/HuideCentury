...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:;" class="on"> <em>添加菜单项</em>
		</a>
	</div>
		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="addMenu" class="form-horizontal" action="/model/menu/addMenu" method="post" enctype="multipart/form-data">
						<div class="control-group">
						    <label class="control-label">导航显示名称:</label>
						    <div class="controls">
						      <input type="text" id="showName" name="showName" maxlength="10"/>
						    </div>
						</div>
						<div class="control-group" id="CatLink">
