...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:void(0);" class="on"> <em>编辑学校主任</em>
		</a>
	</div>
		...
		<div class="pad-10">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
					<form id="editAdminUser" class="form-horizontal" action="/user/admin/edit" method="post">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="email" name="email" value="${user.email}" maxlength="20" />
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<select class="span2" name="roleid">
									<c:forEach items="${userRoleKeySet}"  var="userRoleKey">
										<option value="${userRoleKey}" <c:if test="${userRoleKey==user.roleid}">selected="selected"</c:if>>${userRoleMap[userRoleKey] }</option>
									</c:forEach>
								</select>
							</div>
						</div>
