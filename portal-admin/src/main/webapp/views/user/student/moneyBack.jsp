...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:void(0);" class="on"> <em>退款</em></a>
	</div>
		...
		<div class="pad-10">
			...
			<div class="col-tab">
				<ul class="tabBut cu-li">
					<li id="tab_setting_1" class="on">退款操作</li>
				</ul>
				<div id="div_setting_1" class="contentList pad-10">
					...
					<div class="control-group">
						<label class="control-label"><span class="required">*</span>退款金额:</label>
						<div class="controls">
							<input type="text" class="form-control" id="moneyBackCost" name="moneyBackCost"
								placeholder="请输入退款金额" value="0.0" required="required"  maxlength="8"
								data-validation-callback-callback="checkMoneyBackCost">
						</div>
					</div>
					<div class="control-group">
						<label class="control-label"><span class="required">*</span>退款原因:</label>
						<div class="controls">
							<input type="text" name="remark" id="remark" maxlength="200" value="" required="required"
								placeholder="请输入退款原因"/>
						</div>
					</div>
					<div class="control-group">
						<div class="saveInfo"><button id="submitBtn" class="btn btn-primary" type="submit"><i class="icon-check icon-white"></i>确认退款</button></div>
					</div>
				</div>
			</div>
		</div>
...
function checkMoneyBackCost($el, value, callback){
	callback({
      value: value,
		...
		submitSuccess : function($form, event) {
			...
			$.ajax({
				...
				data : {
					...
					moneyBackCost : $("#moneyBackCost").val(),
