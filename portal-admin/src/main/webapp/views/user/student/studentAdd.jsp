...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:void(0);" class="on"> <em>添加学生</em></a>
	</div>
	<form id="addAdminUser" class="form-horizontal" action="/user/student/add" method="post">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>学号:</label>
							<div class="controls">
								<input type="number" id="studyNo" name="studyNo" value="${studyNo }" maxlength="20" required readonly="readonly"/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>电子邮箱:</label>
							<div class="controls">
								<input type="email" id="email" name="email" value="" maxlength="20" required/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>姓名:</label>
							<div class="controls">
								<input type="text" id="nickname" name="nickname" value="" maxlength="20" required/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>密码:</label>
							<div class="controls">
								<input type="password" id="pwd" name="pwd" value="" maxlength="20" required/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>确认密码:</label>
							<div class="controls">
								<input type="password" id="pwd" name="repassword" value="" maxlength="20" required
						...
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>初始金额：</label>
							<div class="controls">
								<input type="text" id="balance" name="balance" value="0.0" maxlength="6" data-validation-callback-callback="checkBalance"/>
								<p class="help-block"></p>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="studentId" name="studentId" value="" maxlength="50"/>
								<p class="help-block"></p>
							</div>
						</div>
				</div>
...
function checkBalance($el, value, callback){
	callback({
	      value: value,
