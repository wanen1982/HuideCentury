...
<body>
	<div class="content-menu ib-a blue line-x">
		...
		<span>|</span>
		<a href="javascript:void(0);" class="on"> <em>添加老师</em></a>
	</div>
	<form id="addAdminUser" class="form-horizontal" action="/user/teacher/add" method="post" enctype="multipart/form-data">
			...
			<div class="col-tab">
				...
				<div id="div_setting_1" class="contentList pad-10">
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="number" id="age" name="age" value="" maxlength="20" required/>
							</div>
						</div>
						<div class="control-group">
							<label class="control-label"><span class="required">*</span>学历:</label>
							<div class="controls">
								<input type="text" id="educated" name="educated" value="" maxlength="20" required/>
							</div>
						</div>
						<div class="control-group">
							...
							<div class="controls">
								<select class="form-control" name="courseType" id="courseType">
									<c:forEach items="${userRoleKeySet}"  var="userRoleKey">
										...
										<option value="${userRoleKey}">${userRoleMap[userRoleKey] }</option>
										</c:if>
									</c:forEach>
								</select>
							</div>
						...
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" id="mobilephone" name="mobilephone" value="" maxlength="11" required/>
							</div>
						</div>
						<div class="control-group">
						...
						<div class="control-group">
							...
							<div class="controls">
								<textarea id="hobby" name="hobby" rows="4" style="width: 30%" maxlength="400"></textarea>
								<span id="hob_taCountView">0</span>/400
								<p class="help-block"></p>
							</div>
						</div>
				</div>
